...
const tratamento = nomeCliente ? `Prezado(a) ${nomeCliente},` : 'Prezado(a) cliente,';
...
switch (motivo) {
  case 'audio':
    situacao = 'Recebemos sua mensagem de áudio. Para o registro do aceite, a resposta precisa ser enviada por texto.';
    break;
  case 'midia':
    situacao = 'Recebemos seu arquivo. Para o registro do aceite, a resposta precisa ser enviada por texto.';
    break;
  case 'codigo_invalido':
    situacao = `Não localizamos nenhum documento identificado pela letra *${codigo}*.`;
    break;
  case 'falta_codigo':
    situacao = intencao === 'aceite'
      ? 'Identificamos sua intenção de aceitar, porém é necessário informar a qual documento ela se refere.'
      : 'Identificamos sua intenção de não aceitar, porém é necessário informar a qual documento ela se refere.';
    break;
  default:
    situacao = 'Não foi possível identificar sua resposta.';
}
