...
| **`[Termo URC - Assinado]`** | `7ITLaIB5rSc7EoTd` | ativo | **Fluxo atual de aceite** (webhook `/webhook/TERMOS-URC-ASSINADOS`): identifica o documento pela letra (`1A`/`2A`), gera o PDF assinado com evidências, grava `documentos` e, se for LGPD, `parceiros` + FOCO. A Evolution API aponta para ele desde 23/08/2026 |
