...
// Dados preenchidos dinamicamente via nó "seta_Dados"
// ============================================
...
// Formatar CPF (se vier sem formatação, ex: 60112476104)
...
// Formatar Telefone (se vier sem formatação, ex: 67999991234)
...
const dataAceite = dataAtual.toLocaleDateString("pt-BR", {
...
const conteudoHash = `${nomeCompleto}|${cpfFormatado}|${dataAceite}|${Date.now()}`;
  ...
  <div style="max-width:700px;margin:0 auto;background:#ffffff;overflow:hidden;">
    ...
    <div style="padding:15px 40px 8px 40px;line-height:1.6;color:#333333;font-size:13.5px;">
      ...
      <div style="padding:8px 0 4px 0;">
        <p style="margin:0 0 5px 0;font-size:13.5px;"><strong>Data e Hora do Aceite:</strong> ${dataAceite}</p>
        <p style="margin:0 0 5px 0;font-size:13.5px;"><strong>CPF:</strong> ${cpfFormatado}</p>
        <p style="margin:0 0 5px 0;font-size:13.5px;"><strong>Telefone:</strong> ${telefoneFormatado}</p>
      </div>
